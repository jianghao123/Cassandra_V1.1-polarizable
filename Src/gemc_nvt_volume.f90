...
SUBROUTINE GEMC_NVT_Volume(box1, box2)
  ...
  IF ( (int_charge_sum_style(box1) == charge_ewald .or. int_charge_sum_style(box1) == charge_gaussian) .OR. &
       (int_charge_sum_style(box2) == charge_ewald .or. int_charge_sum_style(box2) == charge_gaussian) ) THEN
